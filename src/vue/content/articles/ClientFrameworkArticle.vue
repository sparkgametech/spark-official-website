<template>
    <div class="blog-article">
        ...
        <ul>
            <li><strong>流暢的<a href="/blog/client-reel-engine">滾輪動畫</a></strong>：滾輪是玩家最直覺的體驗核心，必須在 60fps 下維持穩定、自然的旋轉效果，包含加速、減速、彈跳等多種動態過渡</li>
            <li><strong>即時的伺服器通訊</strong>：每一次下注都需要與伺服器即時交換資料，從發送請求到接收結果、處理<a href="/blog/client-network-resource">斷線重連</a>，通訊層必須穩定且容錯</li>
