<template>
    <div class="blog-article">
        ...
        <p>
            ...
            <strong>「預備、爆發、餘韻」</strong>的三段結構。<a href="/blog/client-reel-engine">緩動曲線</a>往往比動作設計本身更重要，
        ...
        <p>
            ...
            至於這組視覺風格最初如何從概念發想收斂而來，本系列另有專篇討論<a href="/blog/art-challenges-ai-workflow">前期工作流</a>與 AI 工具的定位。
        </p>
    </div>
</template>
