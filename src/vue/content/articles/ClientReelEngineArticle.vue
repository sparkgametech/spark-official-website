<template>
    <div class="blog-article">
        ...
        <p>
            滾輪引擎談的是手感，但它並不孤立運作：它依賴<a href="/blog/client-framework-architecture">分層架構</a>提供的復用基礎與狀態機給出的啟停指令，
            而素材何時載入、停輪音效如何與畫面對齊則屬於<a href="/blog/client-network-resource">支撐系統</a>的範疇。
